 ...
 * param timeInterval: 投递时间间隔单位分钟，5分钟整数倍，支持5,10,15,20,30,60 (Required)
 */
func NewUpdateShipperRequestWithAllParams(
    regionId string,
    logsetUID string,
    logtopicUID string,
    shipperUID string,
...
func NewUpdateShipperRequestWithoutParam() *UpdateShipperRequest {
...
/* param regionId: 地域 Id(Required) */
func (r *UpdateShipperRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}

/* param logsetUID: 日志集 UID(Required) */
func (r *UpdateShipperRequest) SetLogsetUID(logsetUID string) {
    r.LogsetUID = logsetUID
}

/* param logtopicUID: 日志主题 UID(Required) */
func (r *UpdateShipperRequest) SetLogtopicUID(logtopicUID string) {
    r.LogtopicUID = logtopicUID
}

/* param shipperUID: shipperUID(Required) */
func (r *UpdateShipperRequest) SetShipperUID(shipperUID string) {
    r.ShipperUID = shipperUID
}

/* param compress: 压缩格式，为空不压缩(Optional) */
func (r *UpdateShipperRequest) SetCompress(compress string) {
    r.Compress = &compress
}

/* param fileFormat: 投递格式 json,  origin(原始日志格式), 默认origin(Optional) */
func (r *UpdateShipperRequest) SetFileFormat(fileFormat string) {
    r.FileFormat = &fileFormat
}

/* param fileSize: 投递文件大小，单位MB，支持200,300,400,500,1000(Required) */
func (r *UpdateShipperRequest) SetFileSize(fileSize int64) {
    r.FileSize = fileSize
}

/* param name: 转储任务名称(Required) */
func (r *UpdateShipperRequest) SetName(name string) {
    r.Name = name
}

/* param targetConf: 目的地 配置(Required) */
func (r *UpdateShipperRequest) SetTargetConf(targetConf interface{}) {
    r.TargetConf = targetConf
}

/* param targetType: 转储目的地类型 0: oss, 目前只支持oss(Optional) */
func (r *UpdateShipperRequest) SetTargetType(targetType int64) {
    r.TargetType = &targetType
}

/* param timeInterval: 投递时间间隔单位分钟，5分钟整数倍，支持5,10,15,20,30,60(Required) */
func (r *UpdateShipperRequest) SetTimeInterval(timeInterval int64) {
    r.TimeInterval = timeInterval
}

// GetRegionId returns path parameter 'regionId' if exist,
// otherwise return empty string
func (r UpdateShipperRequest) GetRegionId() string {
    return r.RegionId
}
...
type UpdateShipperResponse struct {
    ...
    Result UpdateShipperResult `json:"result"`
}

type UpdateShipperResult struct {
}