 ...
 * param roleName: 函数绑定的角色名称 (Optional)
 * param rolePolicy: 函数绑定的角色权限策略 (Optional)
 */
...
/* param roleName: 函数绑定的角色名称(Optional) */
func (r *CreateFunctionRequest) SetRoleName(roleName string) {
    r.RoleName = &roleName
}

/* param rolePolicy: 函数绑定的角色权限策略(Optional) */
func (r *CreateFunctionRequest) SetRolePolicy(rolePolicy string) {
    r.RolePolicy = &rolePolicy
}
